...
public class Gerente implements UsuarioAutenticavel{
	...
	public Gerente(DadosPessoais dadosPessoais, Endereco endereco, DadosTrabalhistas dadosTrabalhistas) {
		super();
	...
	private void defineBonificacao() {
		dadosTrabalhistas.setBonificacao(dadosTrabalhistas.getSalario().multiply(BigDecimal.valueOf(0.1)));
	}
	...
	public boolean autentica(String loin, String senha) {
		...
		// autenticacao buscando os dados no cognito
		return false;
	}
